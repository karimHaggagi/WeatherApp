package com.example.data_base.local

import android.content.Context
import androidx.room.Room
import androidx.test.core.app.ApplicationProvider
import androidx.test.ext.junit.runners.AndroidJUnit4
import com.example.data_base.fake.fakeWeatherEntity
import com.example.data_base.fake.fakeWeatherModel
import com.example.data_base.room.RoomLocalDataSource
import com.example.data_base.room.WeatherDao
...
class RoomLocalDataSourceTest {
    ...
    fun save_Location_return_saved_item() = runTest {
        SUT.saveLocationToDatabase(fakeWeatherEntity)
